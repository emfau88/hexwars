...
export default defineLevel({
  ...
  aiThinkMs: 4800, aiDelaySeconds: 8.5, aiAttackDelaySeconds: 28, aiSkill: 0.18, aiActions: 1,
  neutralUnits: [1, 2], growthMultiplier: 2.2, enemyGrowthMultiplier: 0.55,
  bases: { player: { col: 3, row: 9 }, enemy: { col: 3, row: 3 } },
  baseUnits: { player: 23, enemy: 10 },
  features: { all: false, group: false, relay: false }, theme: 'meadow', landscapeStyle: 'meadow-v1',
  activeRows: [[], [], [], [3], [2, 3], [2, 3, 4], [2, 3, 4], [2, 3, 4], [3, 4], [3], [], [], []],
  cells: [
    { col: 2, row: 4, units: 1 }, { col: 3, row: 4, units: 1 },
    { col: 2, row: 5, units: 1 }, { col: 3, row: 5, units: 2 }, { col: 4, row: 5, units: 1 },
    { col: 2, row: 6, units: 1 }, { col: 3, row: 6, units: 2 }, { col: 4, row: 6, units: 1 },
    { col: 2, row: 7, units: 1 }, { col: 3, row: 7, units: 2 }, { col: 4, row: 7, units: 1 },
